...
TelefonosDisp = 5; %número de Telefonos disponibles -> con 5 teléfonos ya se estabiliza en 100% de llamadas atendidas
...
while length(evtQueue)>0
    ...
    fprintf('T=%f -> Na=%d, Nb=%d, TelefonosDisp=%d PorcLlamAcep=%2d \n',t, Na, Nb, TelefonosDisp, porcLlamAcep);
